...
"")
    ...
    def insert_row_booking(self):
            try:
                    ...
                    query = QSqlQuery()
                    query.prepare(
                            "INSERT INTO booking (Booking_id, Guest_id, room_id, checkInDate, CheckOutDate, Totalprice) VALUES (?, ?, ?, ?, ?, ?)")
    ...
    def insert_row_room(self):
            try:
                    ...
                    if query.exec():
                            ...
                            self.tableRoom.insertRow(row_position)
    ...
    def insert_row_staff(self):
            try:
                    ...
                    query = QSqlQuery()
                    query.prepare(
                            "INSERT INTO staff (staff_id, hotell_id, frist_name, last_name, Salary, Position, Date_Of_Birth, phone, Email, Hire_Date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
