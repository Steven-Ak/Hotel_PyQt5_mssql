...
################################################################################
## Form generated from reading UI file 'dokki_hotelSeZvcC.ui'
##
...
class Ui_MainWindow(object):
    ...
    def side_menu_def_0(self):
        if self.side_menu_num == 0:
            ...
            self.pushButton_2.setText("Item 1")
            ...
            self.pushButton_3.setText("Item 2")
            ...
            self.pushButton_4.setText("Item 3")
            ...
            self.pushButton_5.setText("Item 4")
